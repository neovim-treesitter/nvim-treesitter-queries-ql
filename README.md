# nvim-treesitter-queries-ql

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-ql/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-ql/actions/workflows/validate.yml)

Neovim tree-sitter queries for **ql**, part of the
...
- [ ] Changes are scoped to `ql` — do not include files for other languages
